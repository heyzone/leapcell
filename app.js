...
// 环境变量
const UUID = process.env.UUID || 'a87056c0-abeb-45e4-a97e-f23bdf84d191'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'leapcell-harrywujy3462-w5bjcl19.apn.leapcell.dev';                   // 域名或ip,留空将自动获取服务器ip
